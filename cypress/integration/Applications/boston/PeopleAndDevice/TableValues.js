...
class TableValues{
    ...
    compareChartTotalWithTableTotal(dropdownID){
        cy.readFile('./cypress/fixtures/CfsPeopleAndDeviceChart.json').then((total) => {
            ...
            cy.readFile('./cypress/fixtures/CfsPeopleAndDeviceStudentsTable.json').then((value) => {
    ...
    compareTableValuesWithStudentsTable(jsonName){
        cy.readFile('./cypress/fixtures/CfsPeopleAndDeviceStudentsTable.json').then((valueA) => {
