...
class TrackingAtAGlanceSanity{
    isTilesPresent(){
        ...
        TrackingAtAGlanceSanity.isTileVisible(TrackingAtAGlanceObjects.weeklyInActiveStudentID);
    ...
    tilesHeaderCHeck(){
        ...
        TrackingAtAGlanceSanity.checkTileHeader(TrackingAtAGlanceObjects.weeklyInActiveStudentID)
    ...
    tilesTextCheck(){
        ...
        TrackingAtAGlanceSanity.textCheck(TrackingAtAGlanceObjects.weeklyInActiveStudentID)
