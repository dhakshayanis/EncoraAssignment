class EOPopUpObjects{
    ...
    static studentDimensionDropDownOptions = ['Ethnicity', 'Grade','Gender','Special Group ','Student Device Assignment','Student Cohort']
    ...
    static GoogleMeetTile ='Google Meet'
}
export default EOPopUpObjects