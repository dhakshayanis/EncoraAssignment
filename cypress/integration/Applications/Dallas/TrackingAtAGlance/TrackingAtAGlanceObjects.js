class TrackingAtAGlanceObjects{ 
    ...
    static schoolDimensionDropDownOptions = ['School Level', 'Grade Level', 'Division']
    ...
    static studenthotspotdistributionID='[id="9"]'
    ...
    static getTileTitle(tileID){
        ...
        title.set(TrackingAtAGlanceObjects.studenthotspotdistributionID,'STUDENTHOTSPOT DISTRIBUTION');
