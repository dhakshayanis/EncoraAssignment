...
class TrackingAtAGlanceSanity{
    ...
    static weeklyActiveStudentsTitleCheck(){
        cy.contains(TrackingAtAGlanceObjects.getTileTitle(TrackingAtAGlanceObjects.weeklyActiveStudentsID))
            .should('have.text','WEEKLY ACTIVE  STUDENTS')
    }
    tilesHeaderCHeck(){
        ...
        TrackingAtAGlanceSanity.weeklyActiveStudentsTitleCheck()
